...
public class CommonFileController extends BaseController {
    ...
    */
	...
	@RequestMapping(value = "/tabDetailForm", method = RequestMethod.GET)
	public void tabDetailForm(@ModelAttribute CommonFile filee, HttpServletRequest request) {
		CommonFile f = fileeService.getEntityByProperty(CommonFile.class, "manageKey", request.getParameter("manageKey"));
		request.setAttribute("tempBean", f);
	}
}
