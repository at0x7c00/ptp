<%@page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
		...
		<th align="center" data-sortfield="picture" class="${nfn:sortClass(pageBean,'picture')}">
			<spring:message code="props.me.huqiao.smallcms.trace.entity.Product.picture"/>
		</th>
		<th align="center" data-sortfield="description" class="${nfn:sortClass(pageBean,'description')}">
