<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
	...
	<li>
		...
		<c:if test="${not historyView}">
	<li>
		<a href="#qrCodes" data-toggle="tab" <c:if test="${checkResult['qrCode'].changed}">style="color:red;" </c:if>><spring:message code="props.me.huqiao.smallcms.trace.entity.Product.qrCode"/></a>
	</li>
		</c:if>
		<c:if test="${not historyView}">
	<li>
