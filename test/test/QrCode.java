...
public class QrCode {
	...
	public static void main(String[] args) throws IOException {
		BufferedImage image = new QrCode().createQRCodeBitmap("http://www.baidu.com");
		File outputfile = new File("D:\\image.png");
		ImageIO.write(image, "png", outputfile);
	}
	
	// 生成QR图
	private BufferedImage createQRCodeBitmap(String text) {
	    int QR_WIDTH = 525, QR_HEIGHT = 525;
	    try {
	        // 需要引入core包
