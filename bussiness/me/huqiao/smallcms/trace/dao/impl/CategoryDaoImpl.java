...
public class CategoryDaoImpl extends BaseDaoImpl<Category> implements ICategoryDao {
    ...
    public void queryCause(Criteria criteria,Category category){
       if(category.getOrderNum()!=null
		...
		criteria.add(Restrictions.eq("orderNum",category.getOrderNum()));
}
 ...
 && ! category.getRemark().trim().equals("")){
		criteria.add(Restrictions.like("remark",category.getRemark(),MatchMode.ANYWHERE));
}
				if(category.getParent()!=null && category.getParent().getId() != null ){
					criteria.add(Restrictions.eq("parent",category.getParent()));
				}
